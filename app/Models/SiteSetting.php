...
class SiteSetting extends Model
{
    ...
    public static function defaults(): array
    {
        return [
            ...
            'hero_body' => 'A Laravel and Filament travel platform for curated destinations, customer documents, itinerary planning and an admin assistant that helps craft better trips.',
            ...
            'secondary_button_label' => 'Customer Portal',
            'tertiary_button_label' => 'View Packages',
            'metric_one_value' => '7',
            'metric_one_label' => 'core admin modules',
            'metric_two_value' => 'AI',
            'metric_two_label' => 'assistant workspace planned',
            'metric_three_value' => 'PDF',
            'metric_three_label' => 'customer document flow',
            'hero_panel_title' => 'Next sprint: customer portal',
            'hero_panel_body' => 'Login, assigned PDFs, saved itineraries and request history.',
            ...
            'assistant_body' => 'The assistant area starts as a guided workspace. Next we connect it to stored customers, destinations and itineraries, then wire in AI tools for route planning and offer drafts.',
